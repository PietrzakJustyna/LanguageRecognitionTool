...
language_tags = OrderedDict([
                            ('Polish', ['Warszawa', 'Europa', 'Pireneje', 'woda', 'koń', 'chrześcijaństwo', 'przyroda',
                                    'ekosytem', 'Zeus', 'Jan Pawel II', 'powstanie', 'filozofia', 'Zeus', 'kret',
                                    'średniowiecze', 'łacina', 'Fryderyk Chopin', 'Ogniem i Mieczem', 'układ krążenia',
                                    'alkohol', 'Adam Małysz', 'piłka nożna', 'telefon', 'czarna dziura',
                                    'piśmiennictwo', 'dżuma']),

                            ('English', ['actor', 'alcohol', 'cheque', 'cancer',
